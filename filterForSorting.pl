...
es => {
	"a" => 1, "al" => 1, "como" => 1, "con" => 1, "da" => 1, "dar" => 1, "de" => 1, "del" => 1, "el" => 1, "en" => 1, "es" => 1, "está" => 1, "esté" => 1, "ha" => 1, "haga" => 1, "han" => 1, "hay" => 1, "la" => 1, "las" => 1, "le" => 1, "lo" => 1, "los" => 1, "me" => 1, "mes" => 1, "ni" => 1, "no" => 1, "par" => 1, "para" => 1, "por" => 1, "que" => 1, "qué" => 1, "se" => 1, "si" => 1, "son" => 1, "su" => 1, "sus" => 1, "te" => 1, "un" => 1, "una" => 1, "unos" => 1, "y" => 1, },
fr => {
...
it => {
	"a" => 1, "ad" => 1, "ai" => 1, "al" => 1, "alla" => 1, "che" => 1, "ci" => 1, "come" => 1, "con" => 1, "da" => 1, "de" => 1, "dei" => 1, "del" => 1, "della" => 1, "delle" => 1, "dello" => 1, "di" => 1, "e" => 1, "ed" => 1, "gli" => 1, "ha" => 1, "i" => 1, "il" => 1, "in" => 1, "la" => 1, "le" => 1, "lo" => 1, "nel" => 1, "non" => 1, "per" => 1, "se" => 1, "si" => 1, "sia" => 1, "sono" => 1, "su" => 1, "sul" => 1, "sulla" => 1, "sulle" => 1, "sullo" => 1, "un" => 1, "una" => 1, "uno" => 1, "è" => 1, },
jp => {
