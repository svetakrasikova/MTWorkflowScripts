...
pt_br => {
	"a" => 1, "ao" => 1, "aos" => 1, "ar" => 1, "as" => 1, "com" => 1, "da" => 1, "dado" => 1, "das" => 1, "de" => 1, "do" => 1, "dos" => 1, "e" => 1, "ele" => 1, "em" => 1, "faz" => 1, "foi" => 1, "for" => 1, "há" => 1, "já" => 1, "na" => 1, "nas" => 1, "no" => 1, "nos" => 1, "não" => 1, "o" => 1, "os" => 1, "ou" => 1, "para" => 1, "pode" => 1, "por" => 1, "que" => 1, "se" => 1, "sem" => 1, "ser" => 1, "seu" => 1, "sua" => 1, "tem" => 1, "ter" => 1, "um" => 1, "uma" => 1, "à" => 1, "é" => 1,   },
ru => {
