...
all_metric_names = [ "HUMAN_RANK", "AMBER", "AMBER_nl", "AMBER_ti", "BLEU", "dfki_parseconf", "F15", "F15g3", "meteor-1.3-adq", "meteor-1.3-rank", "mp4ibm1", "mpF", "MTeRater", "MTeRater-Plus", "ROSE", "TER", "tesla-b", "tesla-f", "tesla-m", "TINE-srl_match", "wmpF" ]
